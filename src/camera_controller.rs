...
use bevy::app::{App, Plugin, RunFixedMainLoop, RunFixedMainLoopSystem};
...
impl Plugin for FreeCameraPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(
            RunFixedMainLoop,
            run_freecamera_controller.in_set(RunFixedMainLoopSystem::BeforeFixedMainLoop),
        );
    }
}
...
pub fn run_freecamera_controller(
    ...
    let amount = match accumulated_mouse_scroll.unit {
        ...
        MouseScrollUnit::Pixel => {
            accumulated_mouse_scroll.delta.y / 100. //MouseScrollUnit::SCROLL_UNIT_CONVERSION_FACTOR
        }
    };
    scroll += amount;
